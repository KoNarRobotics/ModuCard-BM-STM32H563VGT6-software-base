...
#define USBD_PRODUCT_HS_STRING        "ModuCard-base-module ComPort" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "ModuCard-base-module ComPort" /* Add your product Full Speed string */
